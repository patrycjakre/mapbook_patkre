users: list = [
    ...
    {'name': 'Patrycja', 'posts': 21, 'city': 'Olsztyn'},
    {'name': 'Kinga', 'posts': 23, 'city': 'Szczecin'},
    {'name': 'Dominik', 'posts': 25, 'city': 'Szczecin'},
    {'name': 'Michał', 'posts': 27, 'city': 'Szczecin'},
    {'name': 'Żerom', 'posts': 29, 'city': 'Szczecin'},
]